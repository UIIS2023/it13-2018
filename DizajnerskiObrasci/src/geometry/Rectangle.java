...
public class Rectangle extends SurfaceShape{
	...
	public Rectangle clone () {
		Rectangle rectangle = new Rectangle(new Point(50,100), 50,100);
	...
	public String toString() {
		return "Rectangle -> Upper Left Point: ( " + this.getUpperLeftPoint().getX() + " , " + this.getUpperLeftPoint().getY() +
				" ) Width: " + width + " Height: " + height + " Outer Color: " + this.getColor().getRGB() + " Inner Color: " + this.getInnerColor().getRGB();
	}
